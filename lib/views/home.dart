    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: CategoriesSection(categories: categories)),
          const SliverToBoxAdapter(child: SizedBox(height: 40)),
          SliverToBoxAdapter(child: DietSection(diets: diets)),
          const SliverToBoxAdapter(child: SizedBox(height: 40)),
...
class PopularDietSection extends StatelessWidget {
  const PopularDietSection({super.key, required this.popularDiets});
...
class PopularDietCard extends StatelessWidget {
  const PopularDietCard({super.key, required this.popularDiet});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          SvgPicture.asset(popularDiet.iconPath, height: 65, width: 65),
          Column(
